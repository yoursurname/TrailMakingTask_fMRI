...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Hassl\\OneDrive - Lund University\\Biofinder\\fMRI-tasks\\TrailMakingTask_fMRI\\TMT_fmri_shorter\\TMT_fmri_shorter.py',
...
row_selection = f"{start_row}:{end_row}"
increase_trial = True
...
for thisBlock in block:
    ...
    print("Condition: ", current_trial) 
    print(trial_count)
    if current_trial == 'TMTA':
    ...
    if trial_count > 0 :
        start_row += n_trial_images*trials_per_block 
        end_row += n_trial_images*trials_per_block 
        row_selection = f"{start_row}:{end_row}"
    ...
    for thisTrial in trials:
        ...
        first_attempt = 0
        print(f"Stimuli row range: {row_selection}")
        increase_trial = True
        # keep track of which components have finished
        ...
        while continueRoutine:
            ...
            if currentLoop.thisN == n_trial_images-1 and t >=0.6:
                currentLoop.thisN = -1
                continueRoutine = False
    ...
    while continueRoutine:
        ...
        if trials.finished and increase_trial:
            trial_count += 1
