...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\emilo\\OneDrive - Lund University\\Experiment paradigms\\TMT_PsychoPY_new\\TMT-B_1\\TMT-B_1_lastrun.py',
...
Instruct = visual.ImageStim(
    win=win,
    name='Instruct', 
    image='C:/Users/emilo/OneDrive - Lund University/Experiment paradigms/TMT_PsychoPY_new/Instructions TMTB.png', mask=None,
...
image_2 = visual.ImageStim(
    win=win,
    name='image_2', 
    image='C:/Users/emilo/OneDrive - Lund University/Experiment paradigms/TMT_PsychoPY_new/Instruktioner TMTB.png', mask=None,
    ori=0.0, pos=(0, 0), size=(1.28, 0.72),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
for thisRestartpractice in restartpractice:
    ...
    trials_practice = data.TrialHandler(nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('TMT-B_1_practice.xlsx'),
...
trials = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMT-B_1_1.xlsx'),
...
trials_2 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMT-B_1_2.xlsx'),
...
trials_3 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMT-B_1_3.xlsx'),
...
trials_4 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMT-B_1_4.xlsx'),
...
trials_5 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMT-B_1_5.xlsx'),
