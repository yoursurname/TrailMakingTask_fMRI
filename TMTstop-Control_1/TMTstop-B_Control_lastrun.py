...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\emilo\\OneDrive - Lund University\\Experiment paradigms\\TMT_PsychoPY_new\\TMTstop-Control_1\\TMTstop-B_Control_lastrun.py',
...
Instruct = visual.ImageStim(
    win=win,
    name='Instruct', 
    image='C:/Users/emilo/OneDrive - Lund University/Experiment paradigms/TMT_PsychoPY_new/Instructions TMTstopControl.png', mask=None,
...
image_2 = visual.ImageStim(
    win=win,
    name='image_2', 
    image='C:/Users/emilo/OneDrive - Lund University/Experiment paradigms/TMT_PsychoPY_new/Instruktioner TMTstopControl.png', mask=None,
    ori=0.0, pos=(0, 0), size=(1.28, 0.72),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
    ...
    for thisTrials_practice in trials_practice:
        ...
        while continueRoutine:
            ...
            if key_resp_practice.status == STARTED and not waitOnFlip:
                theseKeys = key_resp_practice.getKeys(keyList=['1', '2', '3', 'x', 'z'], waitRelease=False)
...
trials = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMTstop-control_1_1.xlsx'),
...
trials_2 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMTstop-control_1_a.xlsx'),
...
trials_3 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMTstop-control_1_2.xlsx'),
...
trials_4 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMTstop-control_1_b.xlsx'),
...
trials_5 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMTstop-control_1_3.xlsx'),
...
for thisTrial_5 in trials_5:
    ...
    for thisComponent in trialComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    trials_5.addData('Stim.started', Stim.tStartRefresh)
    trials_5.addData('Stim.stopped', Stim.tStopRefresh)
    # check responses
    if key_resp_2.keys in ['', [], None]:  # No response was made
        key_resp_2.keys = None
        # was no response the correct answer?!
    ...
    trials_5.addData('key_resp_2.started', key_resp_2.tStartRefresh)
    trials_5.addData('key_resp_2.stopped', key_resp_2.tStopRefresh)
    # the Routine "trial" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    thisExp.nextEntry()
...
trials_6 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMTstop-control_1_c.xlsx'),
...
for thisTrial_6 in trials_6:
    ...
    for thisComponent in trialComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    trials_6.addData('Stim.started', Stim.tStartRefresh)
    trials_6.addData('Stim.stopped', Stim.tStopRefresh)
    # check responses
    if key_resp_2.keys in ['', [], None]:  # No response was made
        key_resp_2.keys = None
        # was no response the correct answer?!
    ...
    trials_6.addData('key_resp_2.corr', key_resp_2.corr)
    if key_resp_2.keys != None:  # we had a response
...
trials_7 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMTstop-control_1_4.xlsx'),
...
for thisTrial_7 in trials_7:
    ...
    for thisComponent in trialComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    trials_7.addData('Stim.started', Stim.tStartRefresh)
    trials_7.addData('Stim.stopped', Stim.tStopRefresh)
    # check responses
    if key_resp_2.keys in ['', [], None]:  # No response was made
        key_resp_2.keys = None
        # was no response the correct answer?!
    ...
    trials_7.addData('key_resp_2.corr', key_resp_2.corr)
    if key_resp_2.keys != None:  # we had a response
        trials_7.addData('key_resp_2.rt', key_resp_2.rt)
    trials_7.addData('key_resp_2.started', key_resp_2.tStartRefresh)
    trials_7.addData('key_resp_2.stopped', key_resp_2.tStopRefresh)
    # the Routine "trial" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    thisExp.nextEntry()
...
trials_8 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMTstop-control_1_d.xlsx'),
...
for thisTrial_8 in trials_8:
    ...
    for thisComponent in trialComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    trials_8.addData('Stim.started', Stim.tStartRefresh)
    trials_8.addData('Stim.stopped', Stim.tStopRefresh)
    # check responses
    if key_resp_2.keys in ['', [], None]:  # No response was made
        key_resp_2.keys = None
        # was no response the correct answer?!
