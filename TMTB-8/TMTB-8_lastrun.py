...
expName = 'TMTB-8'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\emilo\\OneDrive - Lund University\\Experiment paradigms\\TMT_PsychoPY\\TMTB-8\\TMTB-8_lastrun.py',
...
image_2 = visual.ImageStim(
    win=win,
    name='image_2', 
    image='C:/Users/emilo/OneDrive - Lund University/Experiment paradigms/TMT_PsychoPY/InkedInstructBfinal_LI.jpg', mask=None,
...
InstructionsComponents = [image_2, key_resp, text_2]
...
trials = data.TrialHandler(nReps=1.0, method='sequential', 
    ...
    trialList=data.importConditions('TMTB-8.xlsx'),
