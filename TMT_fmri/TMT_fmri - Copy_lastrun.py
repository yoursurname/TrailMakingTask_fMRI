...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\emilo\\OneDrive - Lund University\\Jobb\\Experiments\\TMT_PsychoPY_new\\TMT_fmri_git\\TMT_fmri - Copy_lastrun.py',
...
image_2 = visual.ImageStim(
    win=win,
    name='image_2', 
    image='Instructions_TMT.png', mask=None,
...
Blocks_Control1 = data.TrialHandler(nReps=1.0, method='sequential', 
    ...
    trialList=data.importConditions('TMT_conditions.xlsx', selection='0:2'),
...
for thisBlocks_Control1 in Blocks_Control1:
    ...
    for thisTrials_Control1 in trials_Control1:
        ...
        #if Round == 1 or 2 or 3 or 4: # only on the first trial per round
            #startTime = globalClock.getTime()
        ...
        while continueRoutine:
            ...
            if Version == 'TMT_Control' and globalClock.getTime() - startTime >= 45:
                if Block_paper == 'C1' or 'C2':
                    trials_Control1.finished = True
                    continueRoutine = False
                elif Block_paper == 'C3' or 'C4':
                    trials_Control2.finished = True
                    continueRoutine = False
                elif Block_paper == 'C5' or 'C6':
                    trials_Control3.finished = True
                    continueRoutine = False
                elif Block_paper == 'C7' or 'C8':
                    trials_Control4.finished = True
                    continueRoutine = False
                    
            if Version == 'TMT_A' and globalClock.getTime() - startTime >= 90:      
                if Block_paper == 'A1' or 'A2' or 'A3':
                    trials_TMTA1.finished = True
                    continueRoutine = False
                elif Block_paper == 'A4' or 'A5' or 'A6':
                    trials_TMTA2.finished = True
                    continueRoutine = False
                    
            if Version == 'TMT_B' and globalClock.getTime() - startTime >= 90:
                if Block_paper == 'B1' or 'B2':
                    trials_TMTB1.finished = True
                    continueRoutine = False
                elif Block_paper == 'B3' or 'B4' or 'B5':
                    trials_TMTB2.finished = True
                    continueRoutine = False
    ...
    trials_Control1.saveAsText(filename + 'trials_Control1.csv', delim=',',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
...
Blocks_TMTA1 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMT_conditions.xlsx', selection='2:5'),
...
for thisBlocks_TMTA1 in Blocks_TMTA1:
    ...
    trials_TMTA1.saveAsExcel(filename + '.xlsx', sheetName='trials_TMTA1',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
    trials_TMTA1.saveAsText(filename + 'trials_TMTA1.csv', delim=',',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
...
Blocks_Control2 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMT_conditions.xlsx', selection='5:7'),
...
for thisBlocks_Control2 in Blocks_Control2:
    ...
    trials_Control2.saveAsExcel(filename + '.xlsx', sheetName='trials_Control2',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
    trials_Control2.saveAsText(filename + 'trials_Control2.csv', delim=',',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
...
Blocks_TMTB1 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMT_conditions.xlsx', selection='7:9'),
...
for thisBlocks_TMTB1 in Blocks_TMTB1:
    ...
    trials_TMTB1.saveAsExcel(filename + '.xlsx', sheetName='trials_TMTB1',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
    trials_TMTB1.saveAsText(filename + 'trials_TMTB1.csv', delim=',',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
...
Blocks_Control3 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMT_conditions.xlsx', selection='9:11'),
...
for thisBlocks_Control3 in Blocks_Control3:
    ...
    trials_Control3.saveAsExcel(filename + '.xlsx', sheetName='trials_Control3',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
    trials_Control3.saveAsText(filename + 'trials_Control3.csv', delim=',',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
...
Blocks_TMTA2 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMT_conditions.xlsx', selection='11:14'),
...
for thisBlocks_TMTA2 in Blocks_TMTA2:
    ...
    trials_TMTA2.saveAsExcel(filename + '.xlsx', sheetName='trials_TMTA2',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
    trials_TMTA2.saveAsText(filename + 'trials_TMTA2.csv', delim=',',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
...
Blocks_Control4 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMT_conditions.xlsx', selection='14:16'),
...
for thisBlocks_Control4 in Blocks_Control4:
    ...
    trials_Control4.saveAsExcel(filename + '.xlsx', sheetName='trials_Control4',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
    trials_Control4.saveAsText(filename + 'trials_Control4.csv', delim=',',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
...
Blocks_TMTB2 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('TMT_conditions.xlsx', selection='16:19'),
...
for thisBlocks_TMTB2 in Blocks_TMTB2:
    ...
    trials_TMTB2.saveAsExcel(filename + '.xlsx', sheetName='trials_TMTB2',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
    trials_TMTB2.saveAsText(filename + 'trials_TMTB2.csv', delim=',',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
