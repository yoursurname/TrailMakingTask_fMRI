...
expName = 'TMTA-7'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\emilo\\OneDrive - Lund University\\Experiment paradigms\\TMT_PsychoPY\\TMTA-7\\TMTA-7_lastrun.py',
...
Instruct = visual.ImageStim(
    win=win,
    name='Instruct', 
    image='C:\\\\Users\\\\emilo\\\\OneDrive - Lund University\\\\Experiment paradigms\\\\TMT_PsychoPY\\\\InkedInstructAfinal_LI.jpg', mask=None,
...
trials = data.TrialHandler(nReps=1.0, method='sequential', 
    ...
    trialList=data.importConditions('TMTA-7.xlsx'),
